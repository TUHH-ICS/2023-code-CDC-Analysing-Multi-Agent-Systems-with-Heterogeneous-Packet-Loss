...
%TRIANGLE_GRAPH Generates a Matlab graph object that represents a triangular graph.
%   This function generates a Matlab graph object that represents a triangular graph. The generated
%   graphs are always undirected and can be configured only by their size, which is specified by
%   giving the number of vertices in the bottommost row.

arguments
    baselength (1,1) {mustBeInteger, mustBePositive}
end
