...
classdef ParforProgressMeter < handle
    ...
    methods
        function obj = ParforProgressMeter(elements, options)
            ...
            %       interval -> [Default=0.05] Interval of update, given in fraction of completion

            arguments
                elements (1,1) {mustBeInteger, mustBePositive}
                options.interval(1,1) {mustBePositive, mustBeLessThan(options.interval,1)} = 0.05
            end
